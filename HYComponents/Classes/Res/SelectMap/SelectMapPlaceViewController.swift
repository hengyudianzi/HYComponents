//
//  SelectMapPlaceViewController.swift
//  SmartBusJiNanBusERP
//
...
public typealias MapSelectBlock = (_ poi:BMKPoiInfo)->Void

public class SelectMapPlaceViewController: CFBaseViewController {
    ...
    public var block:MapSelectBlock?
    public var selectPoi:BMKPoiInfo?
    ...
    public override func viewDidLoad() {
        ...
        searchTableView.register(UINib(nibName: "SelectMapPlaceTableViewCell", bundle: GetResourcePng.getCFBundle_New()), forCellReuseIdentifier: "SelectMapPlaceCell")
        
        tableView.register(UINib(nibName: "SelectMapPlaceTableViewCell", bundle: GetResourcePng.getCFBundle_New()), forCellReuseIdentifier: "SelectMapPlaceCell")
...
extension SelectMapPlaceViewController:UITableViewDelegate,UITableViewDataSource{
    ...
    public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "SelectMapPlaceCell") as? SelectMapPlaceTableViewCell
        if tableView.tag == 1  {
...
extension SelectMapPlaceViewController{
...
extension SelectMapPlaceViewController:BMKMapViewDelegate{
...
//MARK: - 定位
extension SelectMapPlaceViewController:BMKLocationManagerDelegate{
...
extension SelectMapPlaceViewController:BMKGeoCodeSearchDelegate{
...
extension SelectMapPlaceViewController:UISearchBarDelegate{
...
extension SelectMapPlaceViewController:BMKSuggestionSearchDelegate{
    /**
     关键字检索结果回调
