...
//上方功能区
@property (nonatomic, strong) UIView *topSub;

//下方功能区
@property (nonatomic, strong) UIView *bottomView;
//下方功能区
@property (nonatomic, strong) UIView *bottomSub;
...
-(UIView *)topSub{
    if (!_topSub ) {
        _topSub = [[UIView alloc] initWithFrame:CGRectMake(0, 0, ScreenWidth, 50)];
        _topSub.backgroundColor = [UIColor colorWithRed:0 green:0 blue:0 alpha:0.2];
    }
    return _topSub;
}
...
-(UIView *)bottomSub{
    if (!_bottomSub) {
        _bottomSub = [[UIView alloc] initWithFrame:CGRectMake(0, ScreenHeight-80, ScreenWidth, 80)];
        _bottomSub.backgroundColor = [UIColor colorWithRed:0 green:0 blue:0 alpha:0.4];
    }
    return _bottomSub;
}
...
-(UIButton *)reCamButton{
    if (_reCamButton == nil) {
        ...
        _reCamButton.frame = CGRectMake(40, 25, 80, 50);
        ...
        _reCamButton.titleLabel.font = [UIFont systemFontOfSize:15.0];
...
-(UIButton *)selectButton{
    if (_selectButton == nil) {
        ...
        _selectButton.frame = CGRectMake(ScreenWidth-120, 25, 80, 50);
...
- (UIImageView *)iconImgView {
    if (_iconImgView == nil) {
        _iconImgView = [[UIImageView alloc]initWithFrame:CGRectMake(0, 0,  60 , 60)];
        _iconImgView.center = self.view.center;
        
        NSString *imageName = @"";
        switch (_type) {
            case IDCard:
                imageName = @"camera_card_front";
                break;
            case IDCard_Front:
                imageName = @"camera_card_front";
                break;
    ...
    if (_tishiLabel == nil) {
        ...
        switch (_type) {
            case IDCard:
                ...
                break;
            case IDCard_Front:
                content = @"请将身份证正面置于此区域\n尝试对其边缘";
                break;
            case IDCard_Back:
                content = @"请将身份证反面置于此区域\n尝试对其边缘";
                break;
            case BusCard:
                content = @"请将公交卡置于此区域\n尝试对其边缘";
                break;
...
- (void)customUI {
    ...
    [self.view addSubview:self.topSub];
    [self.view addSubview:self.bottomView];
    [self.view addSubview:self.bottomSub];
    ...
    [self.topSub mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.right.equalTo(self.view);
    ...
    [self.bottomSub mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.right.equalTo(self.view);
    ...
    [self.iconImgView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.bottom.equalTo(self.kuangImgView.mas_bottom).offset(-40);
        make.right.equalTo(self.kuangImgView.mas_right).offset(-40);
    }];
