...
@interface CustomTabBar ()<PublishAnimateDelegate>
/** selctButton */
...
//        [UIColor colorWithRed:18.0/255.0 green:150.0/255.0 blue:219.0/255.0 alpha:1].CGColor;
...
- (void)setSelectedTextColor:(UIColor *)selectedTextColor{
    ...
    [self.centerBtn setTitleColor:selectedTextColor forState:UIControlStateSelected];
...
- (void)centerBtnClick:(CYCenterButton *)button{
    ...
    PlusAnimate *views = [PlusAnimate standardPublishAnimateWithView:button];
    views.delegate = self;
}
